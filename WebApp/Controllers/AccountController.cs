...
namespace WebApp.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public ILecturerRepository _lecturerRepository;
		...
		public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
		{
			...
			if (ModelState.IsValid)
			{
				...
				else if (model.UserId.Trim().StartsWith("p", StringComparison.Ordinal) && model.UserId.Trim().Length - 1 == 7)
				{
					...
					HttpContext.Session.SetString(groupRole, student.group_role);
		...
		private async Task<IActionResult> LoginTask(LoginViewModel model, string returnUrl = null)
		{
		...
		public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
		{
			...
			if (ModelState.IsValid)
			{
				if (model.UserId.Trim().StartsWith("s") && model.UserId.Trim().Length - 1 == 5)
				{
					...
					var user = new ApplicationUser
					{
						...
						userType = new Lecturer
						{
							...
							staff_id = model.UserId.Substring(1, model.UserId.Length -1),
				...
				else if (model.UserId.Trim().StartsWith("p") && model.UserId.Trim().Length - 1 == 7)
				{
					...
					var user = new ApplicationUser
					{
						...
						userType = new Student
						{
							...
							admin_number = model.UserId.Substring(1, model.UserId.Length -1),
							semester = 1,
							course_id = 1,
							year = 2018
						}
